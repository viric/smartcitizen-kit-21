...
class AllCommands {
	public:
		...
		OneCom com_list[COM_COUNT] {
			...
			OneCom {90,	COM_CONFIG,		"config",	"Shows/sets configuration [-defaults] [-mode sdcard/network] [-pubint seconds] [-readint seconds] [-wifi \"ssid\" [\"pass\"]] [-token token] [-clearbaseline]", config_com},
